...
class TargetAnalysis(ParticleAnalysis):
  ...
  def linear_scan(self, PosMaxErfFit = 6.2e-3, PosEnvelope = None, LSdata = None,
					...
					param0 = [0.5, -1, 7e-3, 0.0002], step = None, return_fig = False, 
                    figsize = (11, 5), box = True, plot_lines = True, **kwargs):
    ...
    ax.plot(self.LSdata.CollPos, self.LSdata.Counts, label='Simulation data')
    #ax.plot(LSdata.CollPos, erfunc(LSdata.CollPos, param0[0], param0[1], param0[2], param0[3]))
    ax.plot(self.LSdata.CollPos, erfunc(self.LSdata.CollPos, params[0], params[1], params[2], params[3]), label="Fit Simulation")
    ax.set_xticks(ticks=ax.get_xticks(), labels=[f"{x_tick*1e3:.{1}f}" for x_tick in ax.get_xticks()])
    ...
    ax.set_ylabel('Comulative Counts (normalized)', fontsize=12)
...
def main():
    ...
    folder_suffix = ''
    folder_list = [
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-22.0__20250124-1429',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-20.9__20250128-1815',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-19.8__20250124-1430',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-18.7__20250128-1817',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-17.6__20250124-1430',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-16.5__20250128-1817',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-15.4__20250124-1431',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-14.3__20250128-1817',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-13.2__20250124-1431',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-12.1__20250128-1818',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-11.0__20250124-1431',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-9.9__20250128-1818',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-8.8__20250124-1432',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-7.7__20250128-1818',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-6.6__20250127-1744',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-5.5__20250128-1818',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-4.4__20250127-1745',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-3.3__20250128-1818',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-2.2__20250127-1745',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-1.1__20250128-1818',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__-0.0__20250124-1436',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__1.1__20250128-1818',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__2.2__20250124-1436',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__3.3__20250128-1818',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__4.4__20250124-1436',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__5.5__20250128-1818',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__6.6__20250124-1437',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__7.7__20250128-1818',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__8.8__20250124-1438',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__9.9__20250128-1819',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__11.0__20250124-1439',
    #'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__12.1__20250128-1821',
    'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__13.2__20250124-1439',
    'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__14.3__20250128-1822',
    'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__15.4__20250124-1440',
    'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__16.5__20250128-1823',
    'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__17.6__20250124-1440',
    'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__18.7__20250128-1824',
    'TWOCRYST_DC_450GeV_TCCP_ANGSCAN__19.8__20250124-1441'
    ]
    ...
    for folder in folder_list:
        ...
        fig_pix, ax_pix = ang_dict['PIX'].plot_y(return_fig=True, set_y_dim = 36000)
        fig_tft, ax_tft = ang_dict['TFT'].plot_y(return_fig=True, set_y_dim = 15000)
        
        PIX_TITLE = f'PIXEL    ' + r'$\Delta\theta_{{TCCP}}:$ ' + f'{(ch_angle - ang_dict["PIX"].TCCP_align_angle)*1e6:.1f}' + r' $\mu$rad   $n_{{abs}}$: ' + f'{ang_dict["PIX"].n_TCCP_absorbed / sum(ang_dict["PIX"].data.xp_crit > -1) * 100:.0f} %' + '  $\epsilon_{{SP}}$: ' + f'{ang_dict["PIX"].TCCP_sim_chann_eff * 100:.1f} %'
        TFT_TITLE = f'TFT    ' + r'$\Delta\theta_{{TCCP}}:$ ' + f'{(ch_angle - ang_dict["TFT"].TCCP_align_angle)*1e6:.1f}' + r' $\mu$rad   $n_{{abs}}$: ' + f'{ang_dict["TFT"].n_TCCP_absorbed / sum(ang_dict["TFT"].data.xp_crit > -1) * 100:.0f} %' + '  $\epsilon_{{SP}}$: ' + f'{ang_dict["TFT"].TCCP_sim_chann_eff * 100:.1f} %'
        ax_pix.set_title(PIX_TITLE, fontsize=14)   
        ax_tft.set_title(TFT_TITLE, fontsize=14)   

        fig_tft2D, ax_tft2D = plt.subplots(figsize=(8, 5))
        ang_dict['TFT'].plot_xy_distribution(fig_tft2D, ax_tft2D, ang_dict['TFT'].data['x'], ang_dict['TFT'].data['y'], vmax=300)
        ax_tft2D.set_title(TFT_TITLE, fontsize=14)   
        

        fig_pix2D, ax_pix2D = plt.subplots(figsize=(8, 5))
        ang_dict['PIX'].plot_xy_distribution(fig_pix2D, ax_pix2D, ang_dict['PIX'].data['x'], ang_dict['PIX'].data['y'],vmax=1e3)
