...
def main():
    ...
    line_test = LineData(run=sys.argv[1], line_file_name = sys.argv[2], 
                     coll_file_name = sys.argv[3])
    line_test.compute_crystals()

if __name__ == '__main__':

    main()
    
    # echo HL_IR7_rematched >> HL_out.out
    # python HL.py HL input_files/HL_IR7_rematched/b4_sequence_patched.json input_files/CollDB_HL_tight_b4.data >> HL_out.out
    
    # echo HL_IR3_IR7_rematched >> HL_out.out
    # python HL.py HL input_files/HL_IR7_IR3_rematched/b4_sequence_patched.json input_files/CollDB_HL_tight_b4.data >> HL_out.out
    
    # echo Run3 >> HL_out.out
    # python HL.py Run3 input_files/flat_top_b2.json input_files/flat_top.yaml >> HL_out.out
